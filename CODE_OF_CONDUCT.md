...
on this repository (the **Security** tab → **Report a vulnerability**, i.e.
<https://github.com/cendorhq/cendor-mcp/security/advisories/new>), which opens a private report only
the maintainers can see. Any `cendorhq` repository also works. All complaints will be reviewed and
